...
Define esquemas para facturación.
"""
...
class FacturaBase(BaseModel):
    ...
    def validate_numero(cls, v: str) -> str:
        if not v.startswith("FAC-"):
            raise ValueError("Número de factura debe iniciar con 'FAC-'")
        return v
...
class PacienteInfo(BaseModel):
    """Información del paciente para facturación."""
    id: str
    nombre: str
    apellido: str
    edad: int
...
class VisitaInfo(BaseModel):
    """Información de una visita (fecha)."""
    fecha: str
